...
from models import GPU_MODE, warmup_models
...
async def health():
    ...
    return {
        ...
        "gpu_mode": GPU_MODE,
        "mode": "gpu" if GPU_MODE else "cpu_fallback",
    }
...
async def generate(request: GenerateRequest):
    ...
    logger.info(f"Starting job {job_id} (mode={'gpu' if GPU_MODE else 'cpu_fallback'})")
